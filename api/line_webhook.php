        ...
        if (preg_match('/^(ผูกบ้าน|reg|link)\s+(\d{5,15})$/i', $userText, $matches)) {
            ...
            try {
                ...
                if ($house) {
                    ...
                    replyTextMessage($replyToken, "❌ ไม่พบรหัสบ้าน (HID): $hid ในฐานข้อมูลระบบกรองประชากรเป้าหมายของอำเภอ" . DISTRICT_NAME . " กรุณาตรวจสอบรหัสบ้านจากการ์ด QR Code หรือติดต่อเจ้าหน้าที่");
                }
            } catch (\Exception $e) {
