...
if (isset($_POST['seed']) || (php_sapi_name() === 'cli' && isset($argv[1]) && $argv[1] === 'seed')) {
    try {
        ...
        $insertVhv->execute(['1001', 'นางใจดี รักสงบ (ประธาน)', 1, '34200101', '10957', $passHash, 1]);
        $insertVhv->execute(['1002', 'นางสมศรี มีสุข (อสม.)', 1, '34200101', '10957', $passHash, 0]);
        $insertVhv->execute(['1003', 'นายสมชาย แข็งแรง (อสม.)', 2, '34200102', '10957', $passHash, 0]);
        ...
        $insertStgDm->execute(['10957', 'รพ.สต.ตาลสุม', '11', '1234567890111', 'นายดำ', 'เก่งจริง', '1', '1965-04-12', '111', '12 ม.1', '34200101', '1', '5', 'ผู้ป่วยเบาหวานเดิม']);
        // DM screening risk group
        $insertStgDm->execute(['10957', 'รพ.สต.ตาลสุม', '12', '1234567890112', 'นางแดง', 'งามยิ่ง', '2', '1972-08-23', '112', '45 ม.1', '34200101', '1', '2', 'กลุ่มเสี่ยงเบาหวาน']);
        // Normal DM target
        $insertStgDm->execute(['10957', 'รพ.สต.ตาลสุม', '13', '1234567890113', 'น.ส.เขียว', 'สดใส', '2', '1985-11-05', '113', '78/1 ม.1', '34200101', '1', '1', 'ปกติ']);
        ...
        // HT high risk target
        $insertStgHt->execute(['10957', 'รพ.สต.ตาลสุม', '12', '1234567890112', 'นางแดง', 'งามยิ่ง', '2', '1972-08-23', '112', '45 ม.1', '34200101', '1', 145, 95, '2']);
        $insertStgHt->execute(['10957', 'รพ.สต.ตาลสุม', '13', '1234567890113', 'น.ส.เขียว', 'สดใส', '2', '1985-11-05', '113', '78/1 ม.1', '34200101', '1', 120, 80, '1']);
        // Target in Moo 2
        $insertStgHt->execute(['10957', 'รพ.สต.ตาลสุม', '14', '1234567890114', 'นายขาว', 'บริสุทธิ์', '1', '1958-02-17', '201', '3 ม.2', '34200102', '1', 135, 85, '2']);
