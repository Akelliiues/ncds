    ...
    <script>
        ...
        function assignTasks(vhvId) {
            ...
            if (screenedTargets.length > 0) {
                ...
                alert(
                    `🚫 ไม่สามารถเปลี่ยนตัว อสม. ได้!\n\n` +
                    `ตรวจพบกลุ่มเป้าหมายที่ได้รับการบันทึกข้อมูลเสร็จสิ้นแล้ว ดังนี้:\n${names}\n\n` +
                    `เพื่อป้องกันการสูญหายของแต้มคะแนนสะสมและประวัติผลงานของ อสม. ท่านเดิม ระบบจึงไม่อนุญาตให้สลับตัวผู้รับผิดชอบงานที่ทำเสร็จแล้ว\n\n` +
                    `หากมีความจำเป็นต้องคัดกรองใหม่หรือจัดสรรใหม่จริงๆ กรุณาแจ้งผู้ดูแลระบบให้ช่วยลบผลคัดกรองเดิมเพื่อรีเซ็ตใบงานกลับเป็นว่างเปล่าก่อนดำเนินการครับ`
                );
                return;
            }
