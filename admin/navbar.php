    ...
    <div class="admin-nav-links">
        ...
        <div class="nav-dropdown">
            ...
            <div class="nav-dropdown-content">
                ...
                <?php endif; ?>
                <a href="emergency_receiver.php" target="ncd_red_alert_station_tab" class="<?= $current_page == 'emergency_receiver.php' ? 'active' : '' ?>" style="color: #DC2626 !important; font-weight: 800;">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
