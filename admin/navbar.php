...
<div class="admin-navbar no-print">
    ...
    <div class="admin-nav-links">
        ...
        <div class="nav-dropdown">
            ...
            <div class="nav-dropdown-content">
                <a href="emergency_receiver.php" target="ncd_red_alert_station_tab" class="<?= $current_page == 'emergency_receiver.php' ? 'active' : '' ?>" style="color: #DC2626 !important; font-weight: 800; background: rgba(220, 38, 38, 0.06);">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span>Red Alert Station</span>
                    <span style="margin-left: auto; background: #DC2626; color: white; border-radius: 4px; padding: 1px 5px; font-size: 9.5px; font-weight: 900; letter-spacing: 0.5px;">LIVE</span>
                </a>
