...
function initDemoMockupDatabase($pdo) {
    try {
        ...
        if ($count == 0 || $pdo->query("SELECT COUNT(*) FROM `demo_mock_target_population` WHERE hoscode = '99999'")->fetchColumn() > 0) {
            // Clear legacy 99999 mock data if any exists
            if ($count > 0) {
                foreach ($tablesToDuplicate as $tbl) {
                    $pdo->exec("TRUNCATE TABLE `demo_mock_$tbl`;");
                }
            }

            // Seed Mock Targets (10+ รายชื่อประชากรกลุ่มเป้าหมายจำลอง สังกัด สสอ.ตาลสุม 00325)
            $mockTargets = [
                ['0032500000001', '1001', '12/1', '1', 'สมชาย', 'ใจดี (จำลอง)', '1968-05-15', '1', '341001', '00325', 1, 1, 'BOTH', 15.4321, 104.9812],
                ['0032500000002', '1002', '45/2', '1', 'สมศรี', 'สุขสรรค์ (จำลอง)', '1955-09-20', '2', '341001', '00325', 1, 0, 'DM_ONLY', 15.4310, 104.9825],
                ['0032500000003', '1003', '88', '2', 'บุญมี', 'มีโชค (จำลอง)', '1962-11-04', '1', '341001', '00325', 1, 1, 'BOTH', 15.4335, 104.9840],
                ['0032500000004', '1004', '101', '2', 'ทองสุข', 'สดใส (จำลอง)', '1975-01-30', '2', '341001', '00325', 0, 1, 'HT_ONLY', 15.4340, 104.9850],
                ['0032500000005', '1005', '15/3', '3', 'วิชัย', 'มั่นคง (จำลอง)', '1958-08-12', '1', '341001', '00325', 1, 1, 'BOTH', 15.4350, 104.9860],
                ['0032500000006', '1006', '77/1', '3', 'วิภาดา', 'รุ่งเรือง (จำลอง)', '1980-03-25', '2', '341001', '00325', 1, 0, 'DM_ONLY', 15.4360, 104.9870],
                ['0032500000007', '1007', '99/4', '4', 'อนันต์', 'เจริญสุข (จำลอง)', '1965-07-18', '1', '341001', '00325', 0, 1, 'HT_ONLY', 15.4370, 104.9880],
                ['0032500000008', '1008', '23/2', '5', 'อุบล', 'มีสุข (จำลอง)', '1972-12-01', '2', '341001', '00325', 1, 1, 'BOTH', 15.4380, 104.9890],
                ['0032500000009', '1009', '54', '1', 'ประเสริฐ', 'เลิศอนันต์ (จำลอง)', '1960-04-10', '1', '341001', '00325', 1, 1, 'BOTH', 15.4325, 104.9818],
                ['0032500000010', '1010', '89/1', '2', 'มณีรัตน์', 'ศรีสว่าง (จำลอง)', '1978-09-05', '2', '341001', '00325', 1, 0, 'DM_ONLY', 15.4338, 104.9845]
            ];
            ...
            $mockAssignments = [
                ['0032500000001', 'DEMO_1001', 2026, 'completed', 1, 1],
                ['0032500000002', 'DEMO_1001', 2026, 'completed', 1, 1],
                ['0032500000003', 'DEMO_1002', 2026, 'completed', 1, 1],
                ['0032500000004', 'DEMO_1002', 2026, 'completed', 1, 1],
                ['0032500000005', 'DEMO_1003', 2026, 'completed', 1, 1],
                ['0032500000009', 'DEMO_1001', 2026, 'pending', 1, 1],
                ['0032500000010', 'DEMO_1002', 2026, 'completed', 1, 1],
                // Round 2 assignments
                ['0032500000001', 'DEMO_1001', 2026, 'completed', 2, 1],
                ['0032500000002', 'DEMO_1001', 2026, 'completed', 2, 1],
                ['0032500000003', 'DEMO_1002', 2026, 'pending', 2, 1],
                ['0032500000004', 'DEMO_1002', 2026, 'pending', 2, 1],
                // Round 3 assignment
                ['0032500000001', 'DEMO_1001', 2026, 'pending', 3, 1]
            ];
            ...
            $stmtS->execute([1, '0032500000001', 'DEMO_1001', 1, 130, 84, 110, 'fpg', 65.0, 168.0, 80.0, 23.0, 1, 1]);
            $stmtS->execute([2, '0032500000002', 'DEMO_1001', 1, 145, 92, 135, 'fpg', 70.0, 158.0, 85.0, 28.0, 2, 1]);
            $stmtS->execute([3, '0032500000003', 'DEMO_1002', 1, 122, 78, 105, 'fpg', 62.0, 162.0, 76.0, 23.6, 1, 1]);
            $stmtS->execute([4, '0032500000004', 'DEMO_1002', 1, 118, 76, 95, 'fpg', 58.5, 160.0, 74.0, 22.8, 1, 1]);
            $stmtS->execute([5, '0032500000005', 'DEMO_1003', 1, 162, 98, 210, 'fpg', 72.0, 165.0, 88.0, 26.4, 3, 1]);
            // Round 2 screening results
            $stmtS->execute([8, '0032500000001', 'DEMO_1001', 2, 124, 80, 102, 'fpg', 64.0, 168.0, 78.0, 22.7, 1, 1]);
            $stmtS->execute([9, '0032500000002', 'DEMO_1001', 2, 138, 88, 120, 'fpg', 68.5, 158.0, 83.0, 27.4, 2, 1]);
            ...
            $stmtE->execute([1, '0032500000003', 2026, 'BOTH', 'DEMO_1002', 'active']);
            ...
            // Seed Mock VHVs
            $mockVhvs = [
                ['DEMO_1001', 'อสม. สมชาย ใจดี (จำลอง สสอ.)', '1', '34100101', '00325', 1],
                ['DEMO_1002', 'อสม. สายสมร มีสุข (จำลอง สสอ.)', '2', '34100102', '00325', 1],
                ['DEMO_1003', 'อสม. บุญทัน เจริญดี (จำลอง สสอ.)', '3', '34100103', '00325', 1]
            ];
            ...
            $stmtH->execute(['00325', 'สำนักงานสาธารณสุขอำเภอตาลสุม (ชุดข้อมูลจำลอง / ทดสอบ)']);
            ...
            $stmtVil->execute(['34100101', '341001', 1, 'หมู่ 1 บ้านตาลสุม (จำลอง)', '00325']);
            $stmtVil->execute(['34100102', '341001', 2, 'หมู่ 2 บ้านดอนใหญ่ (จำลอง)', '00325']);
            $stmtVil->execute(['34100103', '341001', 3, 'หมู่ 3 บ้านโคกสว่าง (จำลอง)', '00325']);
            $stmtVil->execute(['34100104', '341001', 4, 'หมู่ 4 บ้านนาเจริญ (จำลอง)', '00325']);
            $stmtVil->execute(['34100105', '341001', 5, 'หมู่ 5 บ้านโนนงาม (จำลอง)', '00325']);
            ...
            // Seed Mock Critical Alerts (สังกัด 00325 - สสอ.ตาลสุม)
            $mockAlerts = [
                ['00325', '0032500000005', 'วิชัย มั่นคง (จำลอง)', 68, '15/3', '3', '341001', 15.4350, 104.9860, 'ht_crisis (ความดันโลหิตสูงวิกฤต)', 210, 115, 310, 'ปวดศีรษะรุนแรง ตาพร่ามัว ปากเบี้ยว', 'อสม. บุญทัน เจริญดี (จำลอง สสอ.)', '081-234-5678', 'pending'],
                ['00325', '0032500000002', 'สมศรี สุขสรรค์ (จำลอง)', 71, '45/2', '1', '341001', 15.4310, 104.9825, 'dtx_high (น้ำตาลสูงวิกฤต)', 175, 95, 340, 'อ่อนเพลียมาก กระหายน้ำ หายใจหอบ', 'อสม. สมชาย ใจดี (จำลอง สสอ.)', '089-876-5432', 'acknowledged'],
                ['00325', '0032500000007', 'อนันต์ เจริญสุข (จำลอง)', 61, '99/4', '4', '341001', 15.4370, 104.9880, 'ht_crisis (ความดันโลหิตสูงวิกฤต)', 195, 110, 140, 'แน่นหน้าอกร้าวไปกราม', 'อสม. บุญทัน เจริญดี (จำลอง สสอ.)', '081-234-5678', 'referred_hospital']
            ];
            ...
            foreach ($mockAlerts as $ca) {
                $refDest = ($ca[16] === 'referred_hospital') ? 'โรงพยาบาลตาลสุม (10957)' : null;
